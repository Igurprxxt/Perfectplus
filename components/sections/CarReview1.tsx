        ...
        <div className="container">
          <div className="row align-items-end">
            <div className="col-md-9 mb-30 wow fadeInUp">
              <h3 className="neutral-1000">Driving Review</h3>
          ...
          <div className="box-videos-small mt-0">
            <div className="bg-video bg-video-main background-13" />
            <div className="row">
              <div className="col-lg-7">
                <div className="card-grid-video wow fadeIn">
                  <div className="card-image">
                    ...
                    <img
                      className="mr-10"
                      src="/assets/imgs/car-review/car-review-1/img-video-5.jpg"
                      alt="Perfectplus"
                    />
                  </div>
              ...
              <div className="col-lg-5">
                <div className="list-videos-small">
                  <div
                    className="item-video-small wow fadeIn"
                    data-wow-delay="0.1s"
                  >
                    <div className="item-image">
                      <a
                        className="-sm popup-youtube"
                        onClick={() => setOpen(true)}
                      >
                        {" "}
                      </a>
                      <img
                        className="mr-10"
                        src="/assets/imgs/car-review/car-review-1/img-video-6.png"
                        alt="Carento"
                      />
                    </div>
                  ...
                  >
                    <div className="item-image">
                      ...
                      <img
                        className="mr-10"
                        src="/assets/imgs/car-review/car-review-1/img-video-7.jpg"
                        alt="Carento"
                      />
                    </div>
                    <div className="item-info">
                  ...
                  >
                    <div className="item-image">
                      ...
                      <img
                        className="mr-10"
                        src="/assets/imgs/car-review/car-review-1/img-video-8.jpg"
                        alt="Carento"
                      />
                    </div>
                    <div className="item-info">
