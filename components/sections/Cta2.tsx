          ...
          <div className="row ">
            <div className="col-lg-5 pe-lg-5 ">
              <h3 className="text-white wow fadeInDown">
                Want to do course fee calculation?
              </h3>
              <p className="text-lg-medium text-white wow fadeInUp">
                Match with up to 4 best courses to get the lowest rate available
                with no markups and no obligations.
              </p>
            </div>
            <div className="col-lg-6 offset-lg-1">
              <div className="mb-30 background-card p-md-5 p-4 rounded-3 mt-lg-0 mt-30 wow fadeIn">
                <h5 className="neutral-1000 mb-2">Driving School Calculator</h5>
                <p className="text-sm-medium neutral-500 mb-25">
                  Estimate your monthly course fee payments with this
                  calculator.
                </p>
              ...
              <div className="box-authors-partner background-body wow fadeInUp p-4">
                ...
                <div className="authors-partner-right">
                  <p className="text-sm neutral-1000">
                    1684 people used <strong>Carento </strong>in the last
