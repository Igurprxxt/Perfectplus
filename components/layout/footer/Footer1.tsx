        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-2 col-xs-6 footer-2">
              ...
              <ul className="menu-footer">
                <li>
                  <Link href="#">Car Driving Services</Link>
                </li>

                <li>
                  <Link href="#">Course Enrollments</Link>
                </li>
                <li>
                  <Link href="#">Explore Plans</Link>
                </li>
                <li>
            ...
            <div className="row align-items-center justify-content-center">
              <div className="col-md-6 text-md-start text-center mb-20">
                <p className="text-sm color-white">
                  © {new Date().getFullYear()} Perfect Plus Inc. All rights
                  reserved.
                </p>
              </div>
